...
class Subscriptions:
    ...
    _subscriptions: dict[MQTTTopicFilter, set[Callable]]

    def __init__(self) -> None:
        self._subscriptions = {}

    def add(self, topic_filter: str, callback: Callable) -> None:
    ...
    def remove(self, topic_filter: str, callback: Callable) -> int:
    ...
    def get_callbacks(self, topic: str) -> frozenset[Callable]:
